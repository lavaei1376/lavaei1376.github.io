/* =========================================================
   ...
   Reverted per Saeed's instruction: the illustrated-character
   redesign didn't work out and has been dropped. Back to the
   centered single-line sentence, now updated copy, with the
   social-left/signature-right position kept from the redesign
   (matches the nav's logo-on-the-right convention — a real fix,
   not part of what was reverted). Social links are now live.
   ========================================================= */
(function () {
  const SOCIAL_LINKS = {
    linkedin: 'https://www.linkedin.com/in/saeed-lavaei',
    instagram: 'https://www.instagram.com/saeedlavaei/'
  };
  ...
  footer.innerHTML = `
    <div class="site-footer__inner">
      <p class="site-footer__thanks">بیایید با هم همکاری کنیم</p>
