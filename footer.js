/* =========================================================
   ...
   Built from Figma Page 3 closing-band spec:
     - centered single-line thank-you near the top of the band
     - social labels (LinkedIn / Instagram) bottom-left
     - name + logo mark bottom-right
...
(function () {
  ...
  footer.innerHTML = `
    <div class="site-footer__inner">
      <p class="site-footer__thanks">از همراهی‌تان سپاسگزارم</p>
